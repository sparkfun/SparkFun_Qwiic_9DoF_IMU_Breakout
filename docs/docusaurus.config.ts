...
const config: Config = {
    title: 'SparkFun 9DoF IMU Breakout - ICM-20948 (Qwiic) Documentation',
    tagline: 'This Qwiic-enabled IMU Breakout utilizes the ICM-20948 Digital Motion Processor to deliver optimal 9-axis tracking for IoT and wearables projects.',
    ...
    baseUrl: '/SparkFun_Qwiic_9DoF_IMU_Breakout',

    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: 'sparkfun', // Usually your GitHub org/user name.
    projectName: 'SparkFun_Qwiic_9DoF_IMU_Breakout', // Usually your repo name.
    ...
    themeConfig: {
        ...
        docsearch: {
            ...
            //------------------------------------------------------------------
            // // only search in the SparkFun 2D Barcode Scanner Breakout documentation - restrict on the section facet
            searchParameters: {
                facetFilters: ['section:SparkFun_Qwiic_9DoF_IMU_Breakout'],
            },
            ...
            // to be used for the 2D Barcode Scanner Breakout.  This is not available for AskAi.
            //
            ...
            // disabling AskAI for the 2D Barcode Scanner Breakout - can revisit later.
            //
        ...
        navbar: {
            title: 'SparkFun 9DoF IMU (ICM-20948) Breakout Hookup Guide ',
            logo: {
                alt: 'SparkFun Logo',
            ...
            items: [
                ...
                // },
                {
                    href: 'https://github.com/sparkfun/SparkFun_Qwiic_9DoF_IMU_Breakout',
                    position: 'right',
        ...
        footer: {
            ...
            links: [
                {
                    title: '2D Barcode Scanner Breakout Boards',
                    items: [
                        {
                            label: 'QwiicRelay1X1ADPDT',
                            href: 'https://www.sparkfun.com/sparkfun-qwiic-relay-1x1a-dpdt.html'
                        },
                    ],
                },
                {
